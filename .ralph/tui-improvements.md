...
- [x] 5.1 Better error display (status bar shows errors now)
...
- action_delete_task implemented
...
- Remaining: NO_COLOR support, loading spinners, empty states
- Search uses preset demo queries instead of interactive input (could be enhanced)
- Responsive layout needs toggle-detail-pane implementation (i key stub)
